...
@MapperScan(basePackages = {
        "com.github.wangfeng.springboot.mybatis.datasource.mapper.db2"}, sqlSessionFactoryRef = "db2SqlSessionFactoryBean")
public class MybatisDb2Config {
    ...
    public SqlSessionFactoryBean db2SqlSessionFactoryBean() throws Exception {
        ...
        //sqlSessionFactoryBean.setTypeAliasesPackage("com.artisan.domain.db2");
    ...
    public SqlSessionTemplate testSqlSessionTemplate(
            @Qualifier("db2SqlSessionFactoryBean") SqlSessionFactoryBean sqlSessionFactoryBean) throws Exception {
